...
function showMenu() {
    // document.getElementById('topicon-1').style.animation = 'menuLeave 0.2s linear forwards';
    // document.getElementById('topicon-2').style.animation = 'menuLeave 0.2s linear forwards';
...
function hideMenu() {
    ...
    // document.getElementById('topicon-1').style.animation = 'menuEnter 0.1s linear forwards';
    // document.getElementById('topicon-2').style.animation = 'menuEnter 0.1s linear forwards';
    setTimeout(() => {
